...
<body>
    ...
    <section id="main">
        ...
        <div id="side_div2">
            ...
            <input type="text" readonly="readonly" value="${ requestScope.allCheckCount }" />
            <br /><br />
            <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <label style="font-size: 1.3em">月累计审核次数:&nbsp;&nbsp;</label>
            <input type="text" readonly="readonly" value="${requestScope.checkCount}">
            <br /><br />
            <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <label style="font-size: 1.3em">本部门通过次数:&nbsp;&nbsp;</label>
            <input type="text" readonly="readonly" value="${requestScope.checkOfDepart}">
            <br />
        </div>
    </section>
</body>
